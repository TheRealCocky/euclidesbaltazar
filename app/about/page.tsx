...
export default function AboutPage() {
    ...
    const t = {
        en: {
            ...
            projectEnd: ", a digital preservation platform for the Nhaneca-Humbe language, where I apply Next.js, NestJS, and MongoDB to transform complex ethnolinguistic data into scalable digital experiences.",
        ...
        pt: {
            ...
            projectLink: "Nonhande",
            projectEnd: ", uma plataforma de preservação digital da língua Nhaneca-Humbe, onde aplico Next.js, NestJS e MongoDB para transformar dados etnolinguísticos em experiências digitais escaláveis.",
